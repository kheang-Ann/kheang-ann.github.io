  ...
  <section id="projects" class="projects">
    <div class="container">
      <h2 class="section-title">
        <span class="number">03.</span> Featured Projects
...
<script setup>
import { projectsData } from '../data/mockData.js';
